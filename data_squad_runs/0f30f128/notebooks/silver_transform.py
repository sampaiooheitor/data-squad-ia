...
# DQ filtering
error_cond = F.col("`1LH5Ep2Cj_38ITjs1cZVAFULA1wUTuFA3`").isNotNull()
df_clean = df.filter(error_cond)
df_rejected = df.filter(~error_cond).withColumn("_dq_error", F.lit("DQ rule failed: 1LH5Ep2Cj_38ITjs1cZVAFULA1wUTuFA3 not_null"))
